'use strict';(function(){const searchDataURL='/en.search-data.min.19b4c439a0958b781706783c6be7763cd863fee9324a98bb6d398da36a8e59ef.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
