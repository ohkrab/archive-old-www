...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6b93207a0db78784ed1010ebf2bf834116562a96699009044baa60b88865a084.js',function(){input.required=false;search();});}
